...
export default function web3Analytics(userConfig) {
  ...
  async function registerUser(privateKey, did) {
    ...
    const contract = await new Contract(WEB3ANALYTICS_ADDRESS, Web3AnalyticsABI, provider.getSigner(signer.address, signer.privateKey)); // Check if user is already registered
